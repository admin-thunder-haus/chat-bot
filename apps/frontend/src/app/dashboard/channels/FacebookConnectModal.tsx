  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      ...
      if (account.connectionState === 'HEALTHY') {
        ...
        notify(
          'Saved, but authentication failed — check the Page access token',
          'error',
        );
      } else {
      ...
      footer={
        showManual ? (
          <>
            ...
            <Button type="submit" form="facebook-connect-form" loading={saving}>
              Connect Facebook
            </Button>
          </>
        ) : (
      ...
      >
        ...
        >
          <Alert variant="info">
            ...
            never shown again. On save we validate the credentials against Meta
            and point you at this channel&apos;s webhook URL.
          </Alert>
          ...
          <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
            ...
            <ul className="list-disc space-y-1 pl-5 text-xs text-slate-600">
              ...
              <li>
                A valid Page access token with <code>pages_messaging</code>
              </li>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              <Label htmlFor="fb-page" required>
                Facebook Page ID
              </Label>
              <Input
                id="fb-page"
                value={form.pageId}
                disabled={saving}
                invalid={Boolean(fieldErrors.pageId)}
          ...
          <div className="rounded-lg border border-amber-200 bg-amber-50 p-3">
            ...
            <div className="space-y-3">
              <div>
                <Label htmlFor="fb-token" required>
                  Page access token
                </Label>
                <Input
                  id="fb-token"
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div>
                  <Label htmlFor="fb-secret" required>
                    App secret
                  </Label>
                  <Input
                    id="fb-secret"
                ...
                <div>
                  <Label htmlFor="fb-verify" required>
                    Verify token
                  </Label>
                  <Input
                    id="fb-verify"
